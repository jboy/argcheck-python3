...
_TEST_CASES = [
    ...
    TestCase("@validate_call: annot params(:Sequence[int]), args(:tuple[int])",
            ...
            (tuple(get_random_list(get_random_int)),), {},
            ExpectedException(ac.exceptions.CallArgTypeCheckViolation,
                    "CallArgTypeCheckViolation(param=_DeclFuncParam(idx=0, name='p'), arg_that_caused_failure=_FuncCallArg(idx_or_kwd=0, val={ex.arg_that_caused_failure.val!r}), check_that_failed=isTypeOfSequence(type_declared=Sequence), type_declared=typing.Sequence[int], type_received=tuple)",
                    "violation of type check `isTypeOfSequence(type_declared=Sequence)` for param [0]='p' (declared=typing.Sequence[int]; received=tuple): _FuncCallArg(idx_or_kwd=0, val={ex.arg_that_caused_failure.val!r})"),
    ),
    ...
    TestCase("@validate_call: annot params(:Sequence[int]), args(:str)",
            ...
            (get_random_str(),), {},
            ExpectedException(ac.exceptions.CallArgTypeCheckViolation,
                    "CallArgTypeCheckViolation(param=_DeclFuncParam(idx=0, name='p'), arg_that_caused_failure=_FuncCallArg(idx_or_kwd=0, val={ex.arg_that_caused_failure.val!r}), check_that_failed=isTypeOfSequence(type_declared=Sequence), type_declared=typing.Sequence[int], type_received=str)",
                    "violation of type check `isTypeOfSequence(type_declared=Sequence)` for param [0]='p' (declared=typing.Sequence[int]; received=str): _FuncCallArg(idx_or_kwd=0, val={ex.arg_that_caused_failure.val!r})"),
    ),
    ...
    TestCase("@validate_call: annot params(:Sequence[int]), args(:int)",
            ...
            (get_random_int(),), {},
            ExpectedException(ac.exceptions.CallArgTypeCheckViolation,
                    "CallArgTypeCheckViolation(param=_DeclFuncParam(idx=0, name='p'), arg_that_caused_failure=_FuncCallArg(idx_or_kwd=0, val={ex.arg_that_caused_failure.val!r}), check_that_failed=isTypeOfSequence(type_declared=Sequence), type_declared=typing.Sequence[int], type_received=int)",
                    "violation of type check `isTypeOfSequence(type_declared=Sequence)` for param [0]='p' (declared=typing.Sequence[int]; received=int): _FuncCallArg(idx_or_kwd=0, val={ex.arg_that_caused_failure.val!r})"),
    ),
    ...
    TestCase("@validate_call: annot params(:Sequence[int]), args(:MyClass)",
            ...
            (MyClass(get_random_int()),), {},
            ExpectedException(ac.exceptions.CallArgTypeCheckViolation,
                    "CallArgTypeCheckViolation(param=_DeclFuncParam(idx=0, name='p'), arg_that_caused_failure=_FuncCallArg(idx_or_kwd=0, val={ex.arg_that_caused_failure.val!r}), check_that_failed=isTypeOfSequence(type_declared=Sequence), type_declared=typing.Sequence[int], type_received=MyClass)",
                    "violation of type check `isTypeOfSequence(type_declared=Sequence)` for param [0]='p' (declared=typing.Sequence[int]; received=MyClass): _FuncCallArg(idx_or_kwd=0, val={ex.arg_that_caused_failure.val!r})"),
    ),
